...
try:
    from signature import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "signature-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "signature Documentation", "Max Gold", "manual")
]
